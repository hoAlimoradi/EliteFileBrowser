...
internal class FileShareManagerAndroid(
    ...
    companion object {
        ...
        private const val MIME_SIGNAL_CONFIG = "esc"
        private const val MIME_SIGNAL_ENCRYPTED = "esenc"
                ...
                for (ext in typeModelENUM.type.value) {
                    if (path.endsWith(".$ext")) {
                        when (typeModelENUM) {
                            ...
                            FileOpenManagerAndroid.FileTypeModelENUM.SIGNALCONFIG -> return MIME_SIGNAL_CONFIG
                            FileOpenManagerAndroid.FileTypeModelENUM.SIGNALENCRYPTED -> return MIME_SIGNAL_ENCRYPTED
                            else -> return ""
                        }
                    }
                }
